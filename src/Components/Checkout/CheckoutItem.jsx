                                ...
                                <div className="flex justify-between  p-1 items-center m-2">
                                    <label className=" text-sm font-bold	" >Quantity</label>
                                        <input
                                         type="number"
                                          min="0"
                                          className="p-2 w-16 bg-gray-100 font-medium"
                                          value={Quantity}
                                          onChange={({target})=> 
                                          { 
                                   ...
                                   {Update && <button
                                    className="capitalize bg-gray-600 rounded-sm w-20 text-white  py-1 mb-1"
                                     onClick={() => 
                                   {
                                     UpdatingLineItems(product.id , parseInt(Quantity))
                                     setUpdate(false)
                                   }}>
                                      Update
                                    </button>}
